...
<div class="container">
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootswatch@4.5.2/dist/yeti/bootstrap.min.css"
    ...
    <div class="col">
        <a href="/schedule/faculties" class="background-cover schedule-menu item_1">
            <span class="name">
                Расписание<br>по факультетам
            </span>
        </a>
    </div>
    <div class="col">
        <a href="/schedule/teachers" class="background-cover schedule-menu item_2">
            <span class="name">

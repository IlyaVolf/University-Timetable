	...
	<v-dialog v-model="dialog" persistent max-width="600" width="fit-content">
		<v-card>
			...
			<v-card-text class="pb-0">
				<p class="font-weight-black mb-2">Steps to follow after downloading the .ics file</p>
				<div class="text-body-2 font-weight-medium mt-0">
					<ul>
						<li>Open the google calendar settings from the top-right corner.</li>
						<li>In the window that opens, select Import & Export from the left navigation bar.</li>
						<li>Browse the .ics file from your computer and upload it under the import heading.</li>
						<li>Click the import button.</li>
					</ul>
				</div>
				<p class="font-weight-black mt-3 mb-1">
					...
					the attached .ics file. If you cant find the email in your inbox, please check the spam
					folder.
				</p>
			</v-card-text>
